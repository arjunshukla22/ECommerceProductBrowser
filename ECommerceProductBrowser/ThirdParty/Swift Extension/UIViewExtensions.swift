...
extension UIView {
    ...
    /// EZSwiftExtensions
    public func addEZShadow(offset: CGSize, radius: CGFloat, color: UIColor, opacity: Float, cornerRadius: CGFloat? = nil) {
...
public extension UIView {
    ...
    /// EZSwiftExtensions
    @objc func addTapGesture(tapNumber: Int = 1, target: AnyObject, action: Selector) {
   ...
   @objc func addTapGesture(tapNumber: Int = 1, action: ((UITapGestureRecognizer) -> Void)?) {
